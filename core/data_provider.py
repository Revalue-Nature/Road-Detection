...
class DataProvider:
        ...
        for _ in range(n):
            ...
            for o_suffix in self._other_suffix:
                ...
                if self._is_aug:
                    ...
                    sub_data_dict[self._org_suffix] = self.rotation(sub_data_dict[self._org_suffix], 'img', rotate_deg,
                                                                    shift_deg1, shift_deg2, shift_deg3, a, sc_value_z)
                    if len(self._other_suffix) > 0:
                        sub_data_dict[self._other_suffix[0]] = self.rotation(sub_data_dict[self._other_suffix[0]],
                                                                             'msk', rotate_deg, shift_deg1, shift_deg2,
                                                                             shift_deg3, a, sc_value_z)
                # process
    ...
    def rotation(self, x, flag, rotate_deg, shift_deg1, shift_deg2, shift_deg3, a, sc_value_z):
        ...
        #     _x = ndimage.shift(_x, [shift_deg1, shift_deg2], order=0)
